...
const loadarticles =()=>{
    ...
    .then(data => {
        ...
        for (let i = 0; i < data.length; i++) {
            ...
            if (user_param){
                 div.innerHTML = `
                    <div class="w-full overflow-hidden items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row dark:border-gray-700 dark:bg-gray-800 object-cover">
                        <div class="flex flex-col justify-between p-4 leading-normal">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight dark:text-white text-white hover:text-sky-450 ">${info.title}</h5>
                            <p class="mb-3 line-clamp-2 font-normal text-gray-700 dark:text-gray-400">${info.body}</p>
